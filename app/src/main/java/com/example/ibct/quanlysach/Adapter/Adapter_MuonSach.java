...
public class Adapter_MuonSach extends ArrayAdapter<MuonSach> {
    ...
    public Adapter_MuonSach(@NonNull Context context, int resource, @NonNull ArrayList<MuonSach> objects, @NonNull ArrayList<DocGia> objects_1, @NonNull ArrayList<Sach> objects_2) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (view == null) {
            ...
            viewHolder.txtNgayTra.setText("Chưa trả");
